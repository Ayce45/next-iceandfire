...
const Button = ({type, children}: Props) => {
    return (
        type === "cta" ? <div className="rounded-md shadow"><a
            ...
            href="/books/1">{children}</a></div> : <div className="mt-3 sm:mt-0 sm:ml-3"><a target="_blank" rel="noreferrer"
                                                     href="https://github.com/Ayce45/next-iceandfire"
                ...
                <span className="ml-2">{children}</span></a></div>
    )
}
